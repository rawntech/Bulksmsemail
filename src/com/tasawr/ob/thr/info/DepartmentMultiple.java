 ...
 ************************************************************************
 */
package com.tasawr.ob.thr.info;
...
public class DepartmentMultiple extends HttpSecureAppServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (vars.commandIn("DEFAULT")) {
      ...
      String strKeyValue = vars.getGlobalVariable("inpKey", "DepartmentMultiple.key", "");
      String strNameValue = vars.getGlobalVariable("inpName", "DepartmentMultiple.name", "");
      ...
      if (vars.getStringParameter("clear").equals("true")) {
        vars.removeSessionValue("DepartmentMultiple.key");
        vars.removeSessionValue("DepartmentMultiple.name");
        vars.removeSessionValue("DepartmentMultiple.productCategory");
        vars.removeSessionValue("DepartmentMultiple.adorgid");
      }
      String strKey = vars.getGlobalVariable("inpKey", "DepartmentMultiple.key", "");
      String strName = vars.getGlobalVariable("inpName", "DepartmentMultiple.name", "");
      String strProductCategory = vars.getGlobalVariable("inpProductCategory",
          "DepartmentMultiple.productCategory", "");
      String strOrg = vars.getGlobalVariable("inpAD_Org_ID", "DepartmentMultiple.adorgid", "");
  ...
  private void PrintPage(HttpServletResponse response, VariablesSecureApp vars, String strKeyValue,
    ...
    XmlDocument xmlDocument = xmlEngine
        .readXmlTemplate("com/tasawr/ob/thr/info/DepartmentMultiple").createXmlDocument();
    ...
    try {
      ComboTableData comboTableData = new ComboTableData(vars, this, "TABLEDIR",
          "M_Product_Category_ID", "", "", Utility.getContext(this, vars, "#AccessibleOrgTree",
              "DepartmentMultiple"), Utility.getContext(this, vars, "#User_Client",
              "DepartmentMultiple"), 0);
      Utility.fillSQLParameters(this, vars, null, comboTableData, "DepartmentMultiple",
          vars.getSessionValue("DepartmentMultiple.productCategory", ""));
    ...
    if (headers != null) {
      try {
        ...
        if (strNewFilter.equals("1") || strNewFilter.equals("")) { // New
          ...
          strNumRows = DepartmentMultipleData.countRows(this, rownum, strKey, strName,
              strProductCategory, (isSoTrx) ? "Y" : null,
              Utility.getContext(this, vars, "#User_Client", "DepartmentMultiple"),
        ...
        if (this.myPool.getRDBMS().equalsIgnoreCase("ORACLE")) {
          ...
          data = DepartmentMultipleData.select(this, "ROWNUM", strKey, strName, strProductCategory,
              (isSoTrx) ? "Y" : null,
              Utility.getContext(this, vars, "#User_Client", "DepartmentMultiple"),
              Utility.getSelectorOrgs(this, vars, strOrg), strOrderBy, "", oraLimit1, oraLimit2);
        } else {
          String pgLimit = pageSize + " OFFSET " + offset;
          data = DepartmentMultipleData.select(this, "1", strKey, strName, strProductCategory,
              (isSoTrx) ? "Y" : null,
              Utility.getContext(this, vars, "#User_Client", "DepartmentMultiple"),
  ...
  private void printGridDataSelectedRows(HttpServletResponse response, VariablesSecureApp vars,
    ...
    try {
      // build sql orderBy clause
      String strOrderBy = SelectorUtility.buildOrderByClause(strOrderCols, strOrderDirs);
      String strPage = vars.getSessionValue("DepartmentMultiple|currentPage", "0");
  ...
  public String getServletInfo() {
    return "Servlet that presents the multiple Departments seeker";
